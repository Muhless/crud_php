...
<div class="container mt-5">
    ...
    <form action="" method="post">
        <input type="hidden" name="id_barang" value="<?php $barang['id_barang']; ?>">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="harga" name="harga" value="<?php echo $barang['jumlah'];?>" placeholder="Harga Barang..." required>
        </div>
